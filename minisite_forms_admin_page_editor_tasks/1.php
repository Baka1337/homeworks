<form method="get" action="">
    <label for="name">Введите название файла:</label><br/>
    <input type="text" name="name" id="name" placeholder="Например index.html"><br/>
    <input type="submit" value="Создать">
</form>
<?php
if(isset($_GET['name'])){
    $file = 'pages' . DIRECTORY_SEPARATOR . $_GET['name'];
    $handle = fopen($file, 'a+');
    fclose($handle);
}
