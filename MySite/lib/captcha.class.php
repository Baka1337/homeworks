...
class Captcha {
    ...
    private $imgX = 120;  // image width
    private $imgY = 20;   // image height
    private $fontMinSize = 12;  // Min font size
    private $fontMaxSize = 15;   //Max	 font size
    ...
    public function __construct($securityNumber){
