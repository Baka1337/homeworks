...
INSERT INTO `comments` (`id`, `product_id`, `name`, `message`, `email`, `dt`, `status_id`) VALUES
(7, 9, 'Люда', 'Очень вкусный!', 'lyudmila_iskra@yandex.ua', '2016-08-02 14:24:55', 1),
(8, 1, 'Игорь', 'test!!', 'admin@your-site.com', '2016-08-15 12:09:48', 1),
(12, 3, 'Игорь', 'test!', 'admin@your-site.com', '2016-08-15 13:15:43', 1),
...
CREATE TABLE `goods` (
  ...
  `img` varchar(55) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `goods` (`id`, `name`, `alias`, `description`, `price`, `category_id`, `img`, `bestseller`, `is_published`) VALUES
(1, 'Чай чорний Ірландські вершки', 'chay-chorniy-rlandsk-vershki', '<p>Чорний чай зі шматочками арахісу і вершковим ароматом</p>', '69.00', 4, 'img-1.jpg', 1, 0),
(2, 'Чай чорний Чорна Смородина', 'chay-chorniy-chorna-smorodina', '<p>Суміш цейлонських та індійських чаїв з додаванням ягід і листя чорної смородини, і чудовим ароматом цієї чудової ягоди.</p>', '74.00', 4, 'img-2.jpg', 0, 1),
(3, 'Чай чорний Адмірал', 'chay-chorniy-admiral', '<p>Чорний чай зі шматочками яблук, кориці, часточками апельсина, коріандру, кардамону, гвоздики, червоного перцю, з інтригуючим ароматом кориці і яскравим смаком з ледь відчутною гостринкою в післясмаку.</p>', '98.00', 4, 'img-3.jpg', 0, 1),
(4, 'Чай чорний ароматизований Моя прекрасна Леді', 'chay-chorniy-aromatizovaniy-moya-prekrasna-ledi', '<p>Купаж чорного чаю з солодкими родзинками, шматочками плодів ананаса, пелюстками троянди, волошки і ароматом екзотичних фруктів.</p>', '102.00', 4, 'img-4.jpg', 0, 1),
(5, 'Чай чорний ароматизований Масала-2', 'chay-chorniy-aromatizovaniy-masala-2', '<p>Чай Масала - це традиційний напій Індії, який готують із суміші прянощів. За традицією його подають з молоком або великою кількістю цукру. Склад: чорний чай, кориця, аніс, фенхель, імбир, гвоздика, чорний перець.</p>', '120.00', 4, 'img-5.jpg', 0, 1),
(6, 'Чай чорний Іван-чай', 'chay-chorniy-ivan-chay', '<p>Листя зніту збирають на зростаючий місяць, коли стебло і листя рослини насичені соком. Після процесу природногої ферментації, листя сушать в печі. Цінність цього напою з віком тільки збільшується, а смак і аромат стають більш вишуканим, густим і сильним.</p>', '208.00', 4, 'img-6.jpg', 1, 1),
(7, 'Чай чорний ароматизований З халвою', 'chay-chorniy-aromatizovaniy-z-halvoyu', '<p>Чорний чай з насінням соняшника в кольорової глазурі, листом волоського горіха і стевією та ніжним ароматом xалви.</p>', '46.00', 4, 'img-7.jpg', 0, 1),
(8, 'Чай чорний Іван да Марья', 'chay-chorniy-ivan-da-marya', '<p>Купаж чорного чаю і сибірського листового Іван-чаю з шматочками яблук, листям бамбука і волоського горіха, плодами аронії, звіробоєм і ароматом айви.</p>', '125.00', 4, 'img-8.jpg', 0, 1),
(9, 'Чай чорний Ерл Грей Спеціальний', 'chay-chorniy-erl-grey-specialniy', '<p>Суміш цейлонських та індійських чаїв з додаванням пелюсток волошки, цедри апельсина, лимонником, квітками жасмину і оригінальним ароматом бергамоту.</p>', '66.00', 4, 'img-9.jpg', 0, 1),
(10, 'Чай чорний Святий Валентин', 'chay-chorniy-svyatiy-valentin', '<p>Купаж чорного чаю з кокосовою стружкою, шматочками малини і полуниці, цукровими сердечками і ніжним солодким ароматом.</p>', '103.00', 4, 'img-10.jpg', 0, 1),
(11, 'Чай чорний ароматизований Брусничний', 'chay-chorniy-aromatizovaniy-brusnichniy', '<p>Чорний чай з додаванням брусничного листа, сушеної журавлини, шкірки шипшини і медових гранул.</p>', '54.00', 4, 'img-11.jpg', 0, 1),
(12, 'Чай чорний Наполеон', 'chay-chorniy-napoleon', '<p>Купаж чорного чаю з цедрою лимона і приємним ароматом бергамоту.</p>', '56.00', 4, 'img-12.jpg', 0, 1),
(13, 'Чай чорний Венеціанська ніч', 'chay-chorniy-venecianska-nich', '<p>Купаж чорного чаю з гібіскусом, ягодами ожини і червоної смородини, шматочками малини, полуниці і пелюстками піону.</p>', '84.00', 4, 'img-13.jpg', 0, 1),
(14, 'Чай чорний Полуниця з вершками', 'chay-chorniy-polunicya-z-vershkami', '<p>Суміш цейлонських та індійських чаїв з додаванням ягід і листя полуниці і пелюсток сафлору.</p>', '61.00', 4, 'img-14.jpg', 0, 1),
(15, 'Чай чорний Айва з шерімоєю', 'chay-chorniy-ayva-z-sherimoeyu', '<p>Суміш китайських, цейлонських та індійських чаїв з додаванням шматочків абрикоса і ананаса, цедри апельсина, цукатів айви і шеримойї.</p>', '69.00', 4, 'img-15.jpg', 0, 1),
(16, 'Чай чорний Зоряний дощ', 'chay-chorniy-zoryaniy-dosch', '<p>Купаж чорного чаю з пелюстками троянди, соняшника і солодким квітковим ароматом з легкою цитрусовою ноткою.</p>', '41.00', 4, 'img-16.jpg', 0, 1),
(17, 'Чай чорний З імбиром Східний', 'chay-chorniy-z-imbirom-shidniy', '<p>Чорний чай з кардамоном, гвоздикою і шматочками імбиру, цитрусовою кислинкою лимонної трави та медовим присмаком з пряними нотками.</p>', '64.00', 4, 'img-17.jpg', 0, 1),
(18, 'Чай чорний Алазанська Долина', 'chay-chorniy-alazanska-dolina', '<p>Купаж чорного чаю з ягодами смородини, шматочками яблука і трохи терпким ароматом чорної смородини.</p>', '53.00', 4, 'img-18.jpg', 0, 1),
(19, 'Чай чорний Айва з персиком', 'chay-chorniy-ayva-z-persikom', '<p>Суміш китайських, цейлонських та індійських чаїв з додаванням пелюсток апельсина і сафлору, шматочків папайї і манго. Чай ароматизований натуральними маслами айви і папайї.</p>', '86.00', 4, 'img-19.jpg', 0, 1),
(20, 'Чай зелений Бенгальський Тигр', 'chay-zeleniy-bengalskiy-tigr', '<p>Купаж зеленого чаю з шматочками папайї, ананаса, манго, пластівцями моркви, листям полуниці, пелюстками соняшника та сафлору. Сорт вищий.</p>', '93.00', 3, 'img-20.jpg', 0, 1),
...
(22, 'Гун Тін Пуер (Імператорський Пуер)', 'gun-tin-puer-imperatorskiy-puer', '<p>Листовий шу пуер з провінції Юньнань. Гун Тін пуер виготовляється з невеликих чайних листочків з тіпсами. Настій темного кольору з яскравим смаком з нотками сухофруктів та горіхів, має насичений аромат з відтінком деревної кори.</p>', '181.00', 6, 'img-22.jpg', 0, 1),
(23, 'Фен Янь (Око Фенікса)', 'fen-yan-oko-feniksa', '<p>Чайне листя за формою нагадує око фенікса, звідки і пішла назва цього чаю. При заварюванні дає прозорий настій жовто - зеленого кольору з насиченим, солодким смаком і тривалим післясмаком.</p>', '326.00', 7, 'img-23.jpg', 0, 1),
(24, 'Молі Хуа Ча (Китайський класичний з жасмином)', 'moli-hua-cha-kitayskiy-klasichniy-z-zhasminom', '<p>Традиційний зелений чай з додаванням пелюсток жасмину. При заварюванні виходить світло-жовтий настій з тонким ароматом жасмину і м''яким смаком.</p>', '60.00', 7, 'img-24.jpg', 0, 1),
(25, 'Молі Та Бай Хоу (Великий білий ворс)', 'moli-ta-bay-hou-velikiy-biliy-vors', '<p>Цей чай росте в провінції Фуцзянь. При заварюванні він дає темно-золотистий настій з вишуканим жасминовим ароматом, в якому можна розрізнити і тонкі нотки лілії. Смак чаю дуже ніжний, з довгим, солодким присмаком.</p>', '125.00', 7, 'img-25.jpg', 0, 1),
(26, 'Лі Чі Хун Ча (Червоний чай з ароматом Лі Чі)', 'li-chi-hun-cha-chervoniy-chay-z-aromatom-li-chi', '<p>Чай, вирощений в провінції Юньнань. При заварюванні виходить насичений настій, з яскравим ароматом польових трав, приємною кислинкою плода Лі Чі і солодким медовим присмаком.</p>', '81.00', 8, 'img-26.jpg', 0, 1),
(27, 'Білий Пуер ', 'biliy-puer-lyuy-ya-bao-puerni-brunki', '<p>Пуерні бруньки збираються з пуерних дерев в провінції Юннань. Настій світлого кольору з ніжним квітково-весняним смаком і тонким ароматом.</p>', '219.00', 6, 'img-27.jpg', 1, 1),
(28, 'Е-Шен (Дикий зелений пуер)', 'e-shen-dikiy-zeleniy-puer', '<p>Шен пуер з вишуканим смаком з нотками сухофруктів і насиченим терпким ароматом з відтінками сушеної груші.</p>', '186.00', 6, 'img-28.jpg', 1, 1),
(29, 'Червоний молочний чай', 'chervoniy-molochniy-chay', '<p>Червоний китайський чай з провінції Юннань має приємний вершково-молочний смак, з ароматом теплого молока та медово-шоколадними нотками. Чудово зігріває організм, покращує травлення, сприяє правильній роботі печінки і нирок, знімає стрес. Можна заварювати декілька раз.</p>', '79.00', 8, 'img-29.jpg', 0, 1),
(30, 'Червоний чай Юннань', 'chervoniy-chay-yunnan', '<p>Цей чай вирощується в провінції Юньнань. Великі темні листя з золотистим відливом дають настій з незвично легким ароматом і спокійним смаком, який завжди дивує тих, хто звик до терпкості або кенійських цейлонських сортів.</p>', '57.00', 8, 'img-30.jpg', 0, 1),
(31, 'Чай зелений Ганпаудер - Бергамот', 'chay-zeleniy-ganpauder---bergamot', '<p>Китайський зелений чай ганпаудер з цедрою лимона, квітками липи і насиченим, яскравим ароматом бергамоту.</p>', '47.00', 3, 'img-31.jpg', 1, 1),
(32, 'Бай Му Дань (Білий піон)', 'bay-mu-dan-biliy-pion', '<p>Білий чай, вирощений в провінції Фуцзянь. Настою притаманний прозорий колір і ніжний, бархатистий смак.</p>', '140.00', 5, 'img-32.jpg', 0, 1),
(33, 'Бай Хао Інь Чжень (Срібні голки з білими волосками)', 'bay-hao-in-chzhen-sribni-golki-z-bilimi-voloskami', '<p>Чай вирощується в провінції Фуцзянь. Настою притаманний світло-золотистий колір, оксамитовий аромат. На смак цей чай нагадує мед.</p>', '268.00', 5, 'img-33.jpg', 0, 1),
(34, 'Чай зелений Віденський Вальс', 'chay-zeleniy-videnskiy-vals', '<p>Легкий літній чай на основі улуна з квітками апельсина, пелюстками волошки, шматочками полуниці та солодким ароматом банана.</p>', '57.00', 3, 'img-34.jpg', 0, 1),
(35, 'Чай зелений Японська липа', 'chay-zeleniy-yaponska-lipa', '<p>Зелений чай Сенча з додаванням квіток липи, суцвіть ромашки і цедри апельсина.</p>', '71.00', 3, 'img-35.jpg', 0, 1);
...
(1, 'Test', '(050)321-23-21', 'test@test.com', 'Test message'),
(2, 'Игорь', '(067)899-90-76', 'admin@your-site.com', 'тестирую!');
...
INSERT INTO `users` (`id`, `login`, `surname`, `name`, `city`, `street`, `house`, `flat`, `phone`, `email`, `role`, `password`, `is_active`) VALUES
(1, 'Admin', 'Бакал', 'Игорь', 'Киев', 'Урловская', '17', '50', '(050)123-53-25', 'baka@mail.ua', 'admin', '5a37bc44d6d11dbc47e575b1d8c025e1', 1),
(13, 'codecat', 'Котовский', 'Дима', 'Киев', 'Бойченка', '', '', '(050)357-85-98', 'baka@mail.ua', 'user', '725e62af7368f5a6453ddffc7737314a', 1),
(14, 'general', 'Васин', 'Матвейчик', 'Киев', 'Ревуцкого', '12', '151', '(093)698-12-36', 'baka@mail.ua', 'user', '9660562d2959be8a22c0d8fd1350c4ae', 1);
